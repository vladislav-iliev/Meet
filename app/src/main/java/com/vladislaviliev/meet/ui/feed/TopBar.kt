...
internal fun FeedTopBar(modifier: Modifier = Modifier) {
    Surface(modifier.fillMaxWidth()) {
        ...
        val horizontalPadding = dimensionResource(R.dimen.feed_list_padding) + dimensionResource(R.dimen.feed_card_padding)
        val verticalPadding = dimensionResource(R.dimen.feed_list_padding)

        Column(Modifier.statusBarsPadding().padding(horizontalPadding, verticalPadding)) {
